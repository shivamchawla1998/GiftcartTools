...
import {
  Logout,
  logout
} from "../../../chunk-RW6YXHBL.js";
import "../../../chunk-UJQBYPRO.js";
import "../../../chunk-KDOLMUJB.js";
import "../../../chunk-RP2ISWQN.js";
...
describe("logs out", () => {
  test("clears the session", async () => {
    ...
    await Logout.run();
    globalExpect(logout).toHaveBeenCalledOnce();
    globalExpect(outputMock.success()).toMatchInlineSnapshot('"Logged out from Shopify"');
  });
});
