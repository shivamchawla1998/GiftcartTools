...
import {
  require_react_dom
} from "/build/_shared/chunk-YMXJAOCI.js";
import {
  require_react
...
var import_react_to_print = __toESM(require_lib());
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\routes\\\\app.barcode-generator.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1723115660448.9097";
}
var BarcodePrintable = ({
  data,
  labelsPerPage,
  pageRef
}) => {
  const totalLabels = data.reduce((acc, item) => acc + Number(item.noOfLabels), 0);
  const pageStyle = {
    width: "210mm",
    // A4 width in mm
    height: "297mm",
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { ref: pageRef, children: data.length > 0 && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [...Array(Math.ceil(totalLabels / labelsPerPage))].map((_, pageIndex) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: pageStyle, children: [...Array(labelsPerPage)].map((_2, labelIndex) => {
    var _a;
    const labelIndexOnPage = pageIndex * labelsPerPage + labelIndex;
    if (labelIndexOnPage < totalLabels) {
      const itemIndex = Math.floor(labelIndexOnPage / Number((_a = data[0]) == null ? void 0 : _a.noOfLabels));
      const item = data[itemIndex];
      const labelIndexInItem = labelIndexOnPage % Number(item == null ? void 0 : item.noOfLabels);
      return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: labelStyle, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(BarcodeGenerator_default, { data: {
        itemName: item == null ? void 0 : item.itemName,
        itemCode: item == null ? void 0 : item.itemCode,
        noOfLabels: item == null ? void 0 : item.noOfLabels,
        header: item == null ? void 0 : item.header,
        line1: item == null ? void 0 : item.line1,
        line2: item == null ? void 0 : item.line2
      } }, void 0, false, {
        fileName: "app/routes/app.barcode-generator.tsx",
        lineNumber: 62,
        columnNumber: 25
      }, this) }, labelIndexOnPage, false, {
        fileName: "app/routes/app.barcode-generator.tsx",
        lineNumber: 61,
        columnNumber: 20
      }, this);
...
var IndividualComponent = ({
  ...
  _s();
  const [componentData, setComponentData] = (0, import_react.useState)({
    itemName: "",
    itemCode: "",
    noOfLabels: "",
    header: "",
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(InlineStack, { gap: "500", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TextField, { label: "Item Name", value: componentData.itemName, onChange: (value) => handleInputChange("itemName", value), autoComplete: "off" }, void 0, false, {
      fileName: "app/routes/app.barcode-generator.tsx",
      lineNumber: 103,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TextField, { label: "Item Code", value: componentData.itemCode, onChange: (value) => handleInputChange("itemCode", value), autoComplete: "off" }, void 0, false, {
      fileName: "app/routes/app.barcode-generator.tsx",
      lineNumber: 104,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TextField, { label: "No. Of Labels", type: "number", value: componentData.noOfLabels, onChange: (value) => handleInputChange("noOfLabels", value), autoComplete: "off" }, void 0, false, {
      fileName: "app/routes/app.barcode-generator.tsx",
      lineNumber: 105,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TextField, { label: "Header", value: componentData.header, onChange: (value) => handleInputChange("header", value), autoComplete: "off" }, void 0, false, {
      fileName: "app/routes/app.barcode-generator.tsx",
      lineNumber: 106,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TextField, { label: "Line 1", value: componentData.line1, onChange: (value) => handleInputChange("line1", value), autoComplete: "off" }, void 0, false, {
      fileName: "app/routes/app.barcode-generator.tsx",
      lineNumber: 107,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TextField, { label: "Line 2", value: componentData.line2, onChange: (value) => handleInputChange("line2", value), autoComplete: "off" }, void 0, false, {
      fileName: "app/routes/app.barcode-generator.tsx",
      lineNumber: 108,
      columnNumber: 7
    }, this)
...
_s(IndividualComponent, "mdLeekoRYxdGDCxGKsNDMgGS29c=");
_c2 = IndividualComponent;
var BarCodeGenerator = () => {
  ...
  const [componentList, setComponentList] = (0, import_react.useState)([]);
  const [selectedPrinter, setSelectedPrinter] = (0, import_react.useState)("Regular Printer");
  const [selectedSize, setSelectedSize] = (0, import_react.useState)("65 Labels (38 * 21mm)");
  ...
  const handlePrinterChange = (0, import_react.useCallback)((value) => setSelectedPrinter(value), []);
  const handleSizeChange = (0, import_react.useCallback)((value) => setSelectedSize(value), []);
  const optionsPrinter = [{
    label: "Regular Printer",
    value: "Regular Printer"
  }];
  const optionsSize = [{
    label: "65 Labels (38 * 21mm)",
    value: "65 Labels (38 * 21mm)"
  }];
  const addComponent = () => {
    setComponentList((prevList) => [...prevList, {}]);
  };
  const handleComponentDataChange = (0, import_react.useCallback)((index, data) => {
    setComponentList((prevList) => prevList.map((item, i) => i === index ? data : item));
  }, [setComponentList]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Page, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ui-title-bar", { title: "Barcode Generator" }, void 0, false, {
      fileName: "app/routes/app.barcode-generator.tsx",
      lineNumber: 164,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout.Section, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Card, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(InlineStack, { gap: "500", align: "end", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Select, { label: "Printer", options: optionsPrinter, onChange: handlePrinterChange, value: selectedPrinter, labelInline: true }, void 0, false, {
          fileName: "app/routes/app.barcode-generator.tsx",
          lineNumber: 169,
          columnNumber: 15
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Select, { label: "Size", labelInline: true, options: optionsSize, onChange: handleSizeChange, value: selectedSize }, void 0, false, {
          fileName: "app/routes/app.barcode-generator.tsx",
          lineNumber: 170,
          columnNumber: 15
        }, this),
        componentList.length > 0 ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button, { variant: "tertiary", onClick: addComponent, children: "+ Add More" }, void 0, false, {
          fileName: "app/routes/app.barcode-generator.tsx",
          lineNumber: 172,
          columnNumber: 19
        }, this) }, void 0, false, {
          ...
          lineNumber: 171,
          columnNumber: 43
        }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button, { variant: "tertiary", onClick: addComponent, children: "+ Add" }, void 0, false, {
          fileName: "app/routes/app.barcode-generator.tsx",
          lineNumber: 176,
          columnNumber: 19
        }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout.Section, { children: componentList.map((data, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-12", style: {
        marginTop: "10px"
      }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Card, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(IndividualComponent, { index, onDataChange: handleComponentDataChange }, index, false, {
        fileName: "app/routes/app.barcode-generator.tsx",
        lineNumber: 188,
        columnNumber: 17
      }, this) }, void 0, false, {
      ...
      componentList.length > 0 && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout.Section, { children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Card, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button, { variant: "primary", onClick: handlePrint, children: "Generate" }, void 0, false, {
            fileName: "app/routes/app.barcode-generator.tsx",
            lineNumber: 195,
            columnNumber: 17
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Card, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(InlineStack, { gap: "100", children: componentList.map((value, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: value.itemCode && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(BarcodeGenerator_default, { data: value }, void 0, false, {
            fileName: "app/routes/app.barcode-generator.tsx",
            lineNumber: 204,
            columnNumber: 42
          }, this) }, index, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout.Section, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { ref: componentRef, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "printable-page", children: componentList && componentList.length > 0 && componentList.every((item) => "itemName" in item && "itemCode" in item && "noOfLabels" in item && "header" in item && "line1" in item && "line2" in item) && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(BarcodePrintable, { data: componentList, labelsPerPage: 65, pageRef }, void 0, false, {
          fileName: "app/routes/app.barcode-generator.tsx",
          lineNumber: 213,
          columnNumber: 222
        }, this) }, void 0, false, {
...
_s2(BarCodeGenerator, "yb3fXjLP9DynY6MnFQsJUfg3kCU=", false, function() {
  return [import_react_to_print.useReactToPrint];
});
_c3 = BarCodeGenerator;
var app_barcode_generator_default = BarCodeGenerator;
var _c;
var _c2;
var _c3;
$RefreshReg$(_c, "BarcodePrintable");
$RefreshReg$(_c2, "IndividualComponent");
$RefreshReg$(_c3, "BarCodeGenerator");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  app_barcode_generator_default as default
};
//# sourceMappingURL=/build/routes/app.barcode-generator-MAZIRVG7.js.map
